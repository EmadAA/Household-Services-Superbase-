              ...
              <div className="relative mb-8 rounded-lg overflow-hidden border-4 border-teal-600">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <Link
                      to="/services"
                      className="bg-teal-600 hover:bg-teal-700 text-white font-medium py-3 px-6 rounded-full flex items-center transition duration-300 w-[170px] transform hover:scale-105"
                    >
