    ...
    <div className="mt-10 mb-10 shadow-xl gap-6 ml-auto mr-auto box-border border-2 p-4 sm:p-5 rounded-[15px] border-[#E7E7E7] h-auto w-[90%] sm:w-[85%] md:w-[90%] lg:w-[1300px] max-w-[1400px]">
      ...
      <div className="flex justify-between m-3">
        <h3 className="text-lg ">
          <span className="font-semibold">Total Technicians : </span> 30+
        </h3>
         <h3 className="text-lg ">
          <span className="font-semibold">Total Users : </span> 70+
        </h3>
         <h3 className="text-lg ">
          <span className="font-semibold">Total Members : </span> 100+
        </h3>
         <h3 className="text-lg ">
          <span className="font-semibold">Total Service Gigs : </span> 100+
        </h3>
      </div>
    </div>
  );
